...
class ChatbotModel(nn.Module):
    ...
    def __init__(self, input_size, output_size):
        ...
        self.fully_connected_layer1 = nn.Linear(input_size, 128)
        self.fully_connected_layer2 = nn.Linear(128, 64)
        self.fully_connected_layer3 = nn.Linear(64, output_size)
        self.relu = nn.ReLU()
    ...
    def forward(self, x):
        ...
        x = self.dropout(x)
        x = self.relu(self.fully_connected_layer2(x))
        x = self.dropout(x)
